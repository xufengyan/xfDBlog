    ...
    <div class="container">
        <div class="row">
            <div class="col col-xs-12 col-md-12 col-lg-12">
                ...
                <p><#if config.copyright!>${config.copyright} |</#if> Powered by <a href="https://github.com/xufengyan/DBlog" title="xfBlog是一款简洁美观、自适应的Java博客系统..." data-toggle="tooltip" data-placement="right" target="_blank"><i>xfBlog</i></a>  </p>
                <#if url?? && (url == "index")>
