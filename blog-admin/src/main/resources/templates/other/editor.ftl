        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <br>
                    <div class="form-group row">
                        <label class="control-label col-md-2 col-sm-2 col-xs-12" for="name">xfBlog系统定制的编辑器 </label>
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <div id="editor">
                                <p>第三个 demo（xfBlog系统单独定制，支持文件上传）</p>
                                <p>
                                    使用方式：
                                ...
                                <ul>
                                    ...
                                    <li>uploadType: 当前上传文件的场景类型，<strong>最好根据实际业务取名</strong>，它会决定最终上传完成后的文件路径，比如在商品信息管理页中指定了uploadType = goods,那么最终上传完成后的文件路径就是：<code>xfBlog/goods/{filename}.png</code>，默认为空</li>
